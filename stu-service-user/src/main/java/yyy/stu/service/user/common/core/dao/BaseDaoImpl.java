package yyy.stu.service.user.common.core.dao;
...
import yyy.stu.facade.user.common.entity.BaseEntity;
import yyy.stu.facade.user.common.exceptions.BizException;
